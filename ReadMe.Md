...
DailyLog is a secure and user-friendly personal journaling app built with the MERN stack (MongoDB, Express, React, and Node.js). It allows users to easily log in, write, view, and manage their daily entries while ensuring a seamless, distraction-free, and private experience. Prioritizing simplicity, security, and privacy, DailyLog helps you document your thoughts and memories with confidence and peace of mind.

[Live Demo](https://daily-log-iota-lilac.vercel.app)
...
│   │   │   ├── entryModel.js               # Defines the structure of journal entries
...
│   │   │   ├── entryRoutes.js              # Routes for journal entry operations
...
│   │   ├── dailylog-image.jpg              # Application banner image
...
│   │   │   │   ├── entriesApiSlice.js      # API slice for journal entries
...
1. **Clone the repository:**
   ...
   ```bash
   git clone https://github.com/Advika2202/dailylog.git
...
1. **Navigate to the root directory (dailylog, not backend):**
...
Contributions are welcome! If you'd like to improve DailyLog, please follow these steps:
